...
then
  ...
  alias ins='docker start insales_insales_1 insales_redis_1 insales_postgres_1 insales_elasticnext_1 insales_delayedjob_1 insales_sidekiq_1'
  alias 1c_sync="docker-compose exec -u 1000 -w /home/app/code 1c_sync bash -l"
